...
### Features
- Add `adjustsFontSizeToFitWidth` & `minimumScaleFactor` methods
  - Implemented by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#104](https://github.com/space-code/flex-ui/pull/104).

## [1.6.0](https://github.com/space-code/flex-ui/releases/tag/1.6.0)

Released on 2026-06-10. All issues associated with this milestone can be found using this [filter](https://github.com/space-code/flex-ui/milestones?state=closed&q=1.6.0).
...
- Add fluent wrapper for UIContentUnavailableConfiguration
  - Implemented by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#52](https://github.com/space-code/flex-ui/pull/52).
...
### Miscellaneous Tasks
- Delete Mintfile
  - Contributed by [@ns-vasilev](https://github.com/ns-vasilev) in Pull Request [#41](https://github.com/space-code/flex-ui/pull/41).
- Add codeowners
...
[unreleased]: https://github.com/space-code/flex-ui/compare/1.6.0..HEAD
[1.6.0]: https://github.com/space-code/flex-ui/compare/1.5.0..1.6.0
